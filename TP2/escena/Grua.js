class Grua {
    ...
    generarPiezaA(){
        var A = new Cubo(2,RGB(0,0,0),new Textura(URLsTexturas.get("aceroNegro")));
            A.trasladar(0,3,0);
            A.escalar(1,3,1);
            return A;
    }
    generarPiezaB(){
        var B = new Cubo(2,RGB(255,255,0),new Textura(URLsTexturas.get("aceroAmarillo")));
            B.trasladar(0,9,0);
            B.escalar(0.75,3,0.75);
            return B;
    }
    generarPiezaC(){
        var C = new Cilindro(0.5,6,RGB(200,200,200),new TexturaVacia());
            C.trasladar(0,15,0);
            return C;
    }
    generarPiezaD(){
        var D = new Objeto3D();
        D.trasladar(0,19,-2);    
        var habitaculo = new Cubo(1,RGB(255,255,0),new Textura(URLsTexturas.get("aceroAmarillo")));
            habitaculo.escalar(2,1,1);
             D.agregarHijo(habitaculo);
        var techo = new Cubo(0.2,RGB(0,0,0),new Textura(URLsTexturas.get("aceroNegro")));
            techo.trasladar(0,0.45,0.7);
            techo.escalar(10,0.5,2);
             D.agregarHijo(techo);
        var piso = new Cubo(0.2,RGB(0,0,0),new Textura(URLsTexturas.get("aceroNegro")));
            piso.trasladar(0,-0.45,1.4);
            piso.escalar(10,0.5,9);
             D.agregarHijo(piso);
        var varandaFrontal = new Cubo(0.2,RGB(100,100,100),new Textura(URLsTexturas.get("aceroGris")));
            varandaFrontal.trasladar(0,-0.2,2.2);
            varandaFrontal.escalar(10,2,1);
             D.agregarHijo(varandaFrontal);               
        var varandaIzquierda = new Cubo(0.2,RGB(100,100,100),new Textura(URLsTexturas.get("aceroGris")));
            varandaIzquierda.trasladar(0.90,-0.2,1.3);
            varandaIzquierda.escalar(1,2,8);
             D.agregarHijo(varandaIzquierda); 
        var varandaDerecha = new Cubo(0.2,RGB(100,100,100),new Textura(URLsTexturas.get("aceroGris")));
            varandaDerecha.trasladar(-0.90,-0.2,1.3);
            varandaDerecha.escalar(1,2,8);
             D.agregarHijo(varandaDerecha);  
        var soportePoleaIzquierda = new Cubo(0.2,RGB(100,60,30),new Textura(URLsTexturas.get("madera")));
    ...
    generarPiezaE(){
        var E = new Cilindro(0.2,2,RGB(180,180,180),new Textura(URLsTexturas.get("aluminio")));
    ...
    generarPiezaF(){
        ...
        var viga = new Cubo(0.8,RGB(255,255,0),new Textura(URLsTexturas.get("aceroAmarillo")));
    ...
    generarPiezaH(){
        ...
        var soga4 = new Cubo(0.1,RGB(200,190,150));
            ...
            H.agregarHijo(soga4);
        var plataforma = new Cubo(1,RGB(100,60,30),new Textura(URLsTexturas.get("madera")));
