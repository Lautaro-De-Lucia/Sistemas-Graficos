class Tobogan {
    ...
    constructor(posicion =[30,0,-20],alturaSeccion = 5,ancho = 2,color =RGB(200,200,200),niveles=5){
...
class SeccionTobogan extends Objeto3D {
    ...
    cargarSeccion(){
        ...
        var soporte1 = new Cilindro(5,5,0.5,2,RGB(100,60,30));
        soporte1.escalar(1,this.alturaSeccion,1);
        soporte1.trasladar(this.ancho,1/2, 0);
        var soporte2 = new Cilindro(5,5,0.5,2,RGB(100,60,30));
