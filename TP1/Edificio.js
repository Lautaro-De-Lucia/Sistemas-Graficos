class Edificio {
    ...
    generarEdificio(){
        ...
        var base = new Cubo(1,this.colorBase);
        ...
        var ascensor = new Cubo(1,this.colorBase);
            ...
            ascensor.escalar(this.ventanasAncho/2,alturaEdificio,this.ventanasLargo/2);
...
class Piso extends Objeto3D {
    ...
    //Creamos las columnas
        ...
        for (let i = 0; i < posicionesColumnas.length; i++) {
            ...
            var columna = new Cilindro(0.2,this.tamañoVentana,this.colorColumnas);
